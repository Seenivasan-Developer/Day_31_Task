...
3. Find the product price where are not between 400 to 600
...
NOTE: only 3 products available above 500 
...
db.products.find({ $and: [ { product_color : { $eq: "indigo" } }, { product_price: { $eq: 492 } } ] }).pretty()
